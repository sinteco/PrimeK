...
export const fetchDHPNotesDatail = (URL): Action =>({
    type: LOAD_DHPNotesDatail,
    payload: {
        request: {
            url: URL
        }
...
export const fetchHPNoteDetail = (URL): Action => ({
    type: LOAD_HPNoteDetail,
    payload: {
        request: {
            url: URL
        }
