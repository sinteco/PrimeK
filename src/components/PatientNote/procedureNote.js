...
class procedureNote extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offset: 0,
    ...
    componentWillMount() {
        const id = this.props.selectedPatient == 0 ? 0 : this.props.selectedPatient.Id;
        const URL = '/PatientNotes/GetProcedureNoteOfPatient/' + id + "?page=" + this.state.page;
                ...
                <GridItem xs={12} sm={12} md={12}>
                    <Card>
                        <CardHeader color="primary">
                            <h4 className={classes.cardTitleWhite}>Procedure Note</h4>
                        ...
                        <CardBody>
                            ...
                            <Dialog
                                ...
                                >
                                <DialogTitle id="responsive-dialog-title">{" Procedure Note Detail"}</DialogTitle>
                                <DialogContent>
                                    <DialogContentText>
                                    <form>
                                        <TextField
...
export default compose(withStyles(styles),withMobileDialog(), connect(mapStateToProps, mapDispatchToProps))(procedureNote);