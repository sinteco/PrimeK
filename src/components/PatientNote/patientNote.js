                ...
                <GridContainer>
                    <GridItem xs={12} sm={12} md={12}>
                        ...
                        {this.props.isLoading?<CircularProgress className={classes.progress} />:""}
                            ...
                            >
                                <DialogTitle id="responsive-dialog-title">{"Patient Note Detail"}</DialogTitle>
                                <DialogContent row>
...
export default compose(withStyles(styles), withMobileDialog(), connect(mapStateToProps,mapDispatchToProps))(patientNote);